...
int main()
{
    ...
    vector<string> chaosRules =
    {
        ...
        "The current color is locked to the last color card played for 5 turn.",
        "The current color becomes the color of the last card drawn.",
        "The current color cannot repeat thrice in a row.",
        ...
        "Every 0 swaps hands with the opposite player.",
        "Every 1 draws a card.",
        "Every 2 forces the next player to draw 2. Can stack with plus card and 2s.",
        "Every 5 changes the current color randomly.",
        "Every 9 reverses turn order.",
        ...
        "The last card played cannot be played again until a new rule appear. After that, delete this rule",
